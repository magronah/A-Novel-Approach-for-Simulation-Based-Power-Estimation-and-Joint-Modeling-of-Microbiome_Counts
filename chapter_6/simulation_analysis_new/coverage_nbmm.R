...
path = paste0("~/scratch/long/new_sim/",nsubj,"_",ntaxa,"_",ntime,"/nb")
...
left_join(confint, true_para, by = "param_name")
}

saveRDS(res,file = paste0(path0,"results/coverage_nb.rds"))
